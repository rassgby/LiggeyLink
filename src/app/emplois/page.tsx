...
export default function JobListings() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <Head>
        <title>Offres d&apos;emploi | LiggeyLink</title>
        <meta name="description" content="Découvrez les meilleures offres d&apos;emploi dans le numérique" />
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li><Link href="/emplois" className={`font-medium ${darkMode ? 'text-blue-400' : 'text-blue-600'}`}>Offres d&apos;emploi</Link></li>
